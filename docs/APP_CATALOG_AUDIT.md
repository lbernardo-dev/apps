...
| Kinsera | `iOS/Kinsera` | Publicada | 88% | QA en dispositivo físico |
| UpLedger | `iOS/UpLedger` | Desarrollo | 82% | Descarga pública y vídeo |
| Renuvia | `iOS/Renuvia` | Publicada | 84% | Ninguno detectado |
...
- Publicadas: VitalsPath, StreakReps, MaskID, Kinsera y Renuvia.
- Testing: SchoolSnap tiene un build interno válido en TestFlight; no se expone un enlace público que no esté disponible.
- Desarrollo: Culmina, VitalsBud, UpLedger y SnapInbox se presentan con seguimiento y soporte, no como descargas listas.
...
3. Completar los campos pendientes en cada repositorio antes de cambiar un nuevo producto a publicada.
4. Revisar legal, capturas, vídeo y QA físico antes de anunciar cada nueva descarga; Renuvia y Kinsera ya tienen sus enlaces públicos y vídeos de presentación verificados.
