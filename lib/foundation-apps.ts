...
export const vitalsBudApp: AppItem = {
  ...
  followEnabled: true,
  completeness: { score: 48, missing: ["original_icon", "screenshots", "video", "public_download", "final_store_metadata", "physical_device_qa"], verifiedAt: updatedAt, sourcePath: "/Volumes/SSD Externo/DESARROLLO/iOS/VitalsBud" }
};
