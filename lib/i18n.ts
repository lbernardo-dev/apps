...
const dictionaries = {
  es: {
    ...
    "screenshot.kinsera.01-set": "Configura límites familiares con claridad",
    "screenshot.kinsera.02-choose": "Elige apps, categorías y webs",
    "screenshot.kinsera.03-control": "Control local sin vigilancia",
    "screenshot.kinsera.04-time": "Ajusta tiempos para cada momento",
    "screenshot.kinsera.05-pause": "Pausa la protección cuando haga falta",
    "screenshot.kinsera.06-plan": "Planifica rutinas familiares",
    "screenshot.kinsera.07-review": "Revisa el estado de la protección",
    "screenshot.kinsera.08-see": "Consulta informes agregados",
    "screenshot.kinsera.09-privacy": "Privacidad y permisos transparentes",
    "screenshot.kinsera.10-start": "Empieza con una rutina sencilla",
    "screenshot.snapinbox.01": "Convierte capturas en acciones",
    "screenshot.snapinbox.02": "Revisa lo que ha encontrado la app",
    "screenshot.snapinbox.03": "Conserva evidencias útiles",
    "screenshot.snapinbox.04": "Confirma cada siguiente paso",
    "screenshot.snapinbox.05": "Organiza tu bandeja privada",
    "screenshot.snapinbox.06": "Consulta el detalle cuando lo necesitas",
    "screenshot.snapinbox.07": "Archiva lo que ya está resuelto",
    "screenshot.snapinbox.08": "Ajusta la experiencia local",
    "screenshot.snapinbox.09": "Adapta la apariencia",
    "screenshot.snapinbox.10": "Actúa sin enviar datos a la nube"
  },
  ...
  en: {
    ...
    "screenshot.kinsera.01-set": "Set clear family limits",
    "screenshot.kinsera.02-choose": "Choose apps, categories, and websites",
    "screenshot.kinsera.03-control": "On-device control without surveillance",
    "screenshot.kinsera.04-time": "Adjust time for every moment",
    "screenshot.kinsera.05-pause": "Pause protection when needed",
    "screenshot.kinsera.06-plan": "Plan family routines",
    "screenshot.kinsera.07-review": "Review protection status",
    "screenshot.kinsera.08-see": "View aggregate reports",
    "screenshot.kinsera.09-privacy": "Transparent privacy and permissions",
    "screenshot.kinsera.10-start": "Start with a simple routine",
    "screenshot.snapinbox.01": "Turn screenshots into actions",
    "screenshot.snapinbox.02": "Review what the app found",
    "screenshot.snapinbox.03": "Keep useful evidence",
    "screenshot.snapinbox.04": "Confirm every next step",
    "screenshot.snapinbox.05": "Organise your private inbox",
    "screenshot.snapinbox.06": "Open the detail when you need it",
    "screenshot.snapinbox.07": "Archive what is already done",
    "screenshot.snapinbox.08": "Tune the local experience",
    "screenshot.snapinbox.09": "Adjust the appearance",
    "screenshot.snapinbox.10": "Act without sending data to the cloud"
  },
} as const;
