...
const dictionaries = {
  es: {
    ...
    "screenshot.reps.01-today": "Hoy: plan del día y contexto de recuperación",
    "screenshot.reps.02-plan": "Plan de entrenamiento del día",
    "screenshot.reps.03-active-workout": "Entreno en curso con temporizador",
    "screenshot.reps.04-workout-summary": "Resumen de la sesión",
    "screenshot.reps.05-progress": "Progreso y sobrecarga progresiva",
    "screenshot.reps.06-exercise-progress": "Progreso por ejercicio",
    "screenshot.reps.07-muscle-map": "Mapa muscular y biblioteca de ejercicios",
    "screenshot.reps.08-calendar": "Calendario histórico de sesiones",
    "screenshot.reps.09-body-metrics": "Métricas corporales",
    "screenshot.reps.10-apple-health": "Integración con Apple Health",
  ...
  en: {
    ...
    "screenshot.reps.01-today": "Today: today's plan and recovery context",
    "screenshot.reps.02-plan": "Daily workout plan",
    "screenshot.reps.03-active-workout": "Active workout with rest timer",
    "screenshot.reps.04-workout-summary": "Workout summary",
    "screenshot.reps.05-progress": "Progress and progressive overload",
    "screenshot.reps.06-exercise-progress": "Per-exercise progress",
    "screenshot.reps.07-muscle-map": "Muscle map and exercise library",
    "screenshot.reps.08-calendar": "Historical workout calendar",
    "screenshot.reps.09-body-metrics": "Body metrics",
    "screenshot.reps.10-apple-health": "Apple Health integration",
