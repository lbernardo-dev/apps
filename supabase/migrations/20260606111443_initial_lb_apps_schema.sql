...
create policy "editors manage app sections" on public.app_sections
  for all using (public.can_edit_content()) with check (public.can_edit_content());
...
create policy "editors manage app faqs" on public.app_faqs
  for all using (public.can_edit_content()) with check (public.can_edit_content());
...
create policy "editors manage app legal" on public.app_legal_pages
  for all using (public.can_edit_content()) with check (public.can_edit_content());

create policy "public read enabled home sections" on public.home_sections
  for select using (is_enabled = true);
create policy "editors manage home sections" on public.home_sections
  for all using (public.can_edit_content()) with check (public.can_edit_content());

create policy "public read site pages" on public.site_pages
  for select using (true);
create policy "editors manage site pages" on public.site_pages
  for all using (public.can_edit_content()) with check (public.can_edit_content());
...
create policy "public read seo metadata" on public.seo_metadata
  for select using (true);
create policy "editors manage seo metadata" on public.seo_metadata
  for all using (public.can_edit_content()) with check (public.can_edit_content());

create policy "public read assets metadata" on public.assets
  for select using (true);
create policy "editors manage assets metadata" on public.assets
  for all using (public.can_edit_content()) with check (public.can_edit_content());
